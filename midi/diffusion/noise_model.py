...
class NoiseModel:
    ...
    def get_Qt(self, t_int):
        ...
        return utils.PlaceHolder(X=q_x, E=q_e, y=q_y, pos=None)
    ...
    def apply_noise(self, dense_data):
        ...
        z_t = utils.PlaceHolder(X=X_t, E=E_t, y=dense_data.y, pos=pos_t, t_int=t_int,
    ...
    def sample_limit_dist(self, node_mask):
        ...
        return utils.PlaceHolder(X=U_X, E=U_E, y=U_y, pos=pos, t_int=t_int_array, t=t_array,
    ...
    def sample_zs_from_zt_and_pred(self, z_t, pred, s_int):
        ...
        sampled_s = diffusion_utils.sample_discrete_features(prob_X, prob_E, node_mask=z_t.node_mask)
        ...
        z_s = utils.PlaceHolder(X=X_s, E=E_s,
                                y=torch.zeros(z_t.y.shape[0], 0, device=X_s.device), pos=pos,
